...
class ErrorMitigationPipeline:
    ...
    def apply_zero_noise_extrapolation(self, circuit, noise_factors: List[float] = [1.0, 1.5, 2.0]) -> Dict:
    ...
    def apply_measurement_error_mitigation(self, raw_counts: Dict[str, int], calibration_matrix: np.ndarray) -> Dict[str, int]:
        return raw_counts
