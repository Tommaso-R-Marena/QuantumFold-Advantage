...
class ClassicalModel(nn.Module):
    ...
    def __init__(self, input_dim: int = 20, hidden_dim: int = 64, output_dim: int = 3):
        ...
        self.logger.info(
            f"Initialized ClassicalModel: input_dim={input_dim}, hidden_dim={hidden_dim}"
        )
...
class QuantumHybridModel(nn.Module):
    ...
    def __init__(
        self, input_dim: int = 20, hidden_dim: int = 64, output_dim: int = 3, n_qubits: int = 4
    ):
        super().__init__()
        self.input_dim = input_dim
        self.hidden_dim = hidden_dim
        ...
        try:
            ...
            self.logger.info(
                f"Initialized QuantumHybridModel with {n_qubits} qubits, {self.n_layers} layers"
            )
