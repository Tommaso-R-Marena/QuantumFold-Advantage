...
class AblationStudy:
    ...
    def run_all_ablations(self, 
                         n_seeds: int = 3,
                         categories: Optional[List[str]] = None) -> List[AblationResult]:
    ...
    def generate_report(self, output_file: Optional[Path] = None) -> str:
        ...
        for category, results in by_category.items():
            ...
            # Create table
            report.append("| Ablation | TM-score | Δ TM | GDT-TS | Δ GDT | Significant | Params |\n")
            report.append("|----------|----------|---------|--------|---------|-------------|--------|\n")
            ...
            for result in results:
                ...
                report.append(f"| {name} | {tm:.4f} | {tm_change:+.2f}% | {gdt:.2f} | {gdt_change:+.2f}% | {sig} | {params} |\n")
