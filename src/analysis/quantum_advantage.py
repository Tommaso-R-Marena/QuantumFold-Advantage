...
class QuantumAdvantageAnalyzer:
    ...
    def cohens_d(self, 
                ...
                classical_scores: np.ndarray) -> float:
    ...
    def rank_biserial_correlation(self,
                                 quantum_scores: np.ndarray,
                                 classical_scores: np.ndarray) -> float:
    ...
    def paired_ttest(self,
                    quantum_scores: np.ndarray,
                    classical_scores: np.ndarray) -> Tuple[float, float]:
    ...
    def wilcoxon_test(self,
        ...
        """
        return stats.wilcoxon(quantum_scores, classical_scores, 
    ...
    def analyze_advantage(self,
                         ...
                         alpha: float = 0.05,
                         n_comparisons: int = 1) -> AdvantageTestResult:
