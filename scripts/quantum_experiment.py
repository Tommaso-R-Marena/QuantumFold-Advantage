...
def run_experiment(num_runs=5, num_samples=100, epochs=10, output_dir="outputs/quantum_experiment"):
    """
...
if __name__ == "__main__":
    ...
    results = run_experiment(num_runs=5, num_samples=100, epochs=10)
    ...
    print("=" * 60)
    print(
        f"Classical mean val loss: {np.mean(classical_losses):.4f} ± {np.std(classical_losses):.4f}"
    )
